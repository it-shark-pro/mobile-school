...
<p align="center"><img src="images/Birthday-Reminder.png" width="800"></p>
...
## Card Keeper (хранилище информации для скидочных/дебетовых/кредитных карт)

<p align="center"><img src="images/Card-Keeper.png" width="800"></p>

Программа для хранения скидочных/дебетовых/кредитных карт, которые с помощью камеры распознаются и сохраняются локально и секьюрно. Можно использовать скидочные карты с помощью телефона (отображение шрих кода карточки на экране смарфона).
