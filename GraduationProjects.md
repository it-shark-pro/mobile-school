...
<p align="center"><img src="images/Money-Splitter.png" width="800"></p>

Программа, которая позволяет вносить, хранить и аккумулировать долги в компании людей, позволяя, в конечном итоге, просто расчитать всю компанию людей и узнать кто/кому/сколько должен. Может работать с несколькими валютами, и позволяет переводить долги из одной валюты в другую по обменному курсу.

**Требования к приложению:**
- Добавление различных мероприятий (и людей участвущих в мероприятии), в которых может потребоваться расчет долгов: путешествия, рестораны и т.д.
...
- Настройки оповещений (напоминания о неоплаченных долгах).
